...
test('it can set properties on an event', function () {
    ...
    $dateLastModified = new DateTime('17 may 2019');
    $dateStarts = new DateTime('18 may 2019');
    $dateEnds = new DateTime('19 may 2019');

    $payload = Event::create('An introduction into event sourcing')
        ->description('By Freek Murze')
        ->createdAt($dateCreated)
        ->lastModifiedAt($dateLastModified)
    ...
    PayloadExpectation::create($payload)
        ...
        ->expectPropertyValue('LAST-MODIFIED', $dateLastModified)
